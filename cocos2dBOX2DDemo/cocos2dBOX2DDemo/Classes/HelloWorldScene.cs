...
namespace cocos2dBOX2DDemo
{
    public class cocos2dBOX2DDemoScene : CCLayer
    {
        /// <summary>
        ...
        public static CCScene scene()
        {
            ...
            CCLayer layer = cocos2dBOX2DDemoScene.node();
        ...
        {
            cocos2dBOX2DDemoScene ret = new cocos2dBOX2DDemoScene();
            if (ret.init())
            {
                return ret;
            }

...
namespace cocos2dBox2DBreakOutDemo
{
    public class cocos2dBox2DBreakOutDemoScene : CCLayer
    {
        /// <summary>
        ...
        public static CCScene scene()
        {
            ...
            CCLayer layer = cocos2dBox2DBreakOutDemoScene.node();
        ...
        {
            cocos2dBox2DBreakOutDemoScene ret = new cocos2dBox2DBreakOutDemoScene();
            if (ret.init())
            {
                return ret;
            }
